---
name: taco-historian
description: Compiles the definitive database of Trump TACO (threat→backdown) events. First agent in the pipeline. Run this first — no prerequisites required. Outputs data/taco_events.csv and reports/01_taco_pattern_bible.md Part 1.
---
