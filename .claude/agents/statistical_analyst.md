...
description: Applies event-study methodology, GARCH(1,1), and regression analysis to the TACO event database. Produces 3-5 statistical laws characterizing Trump's market behavior. Prerequisites: data/taco_events.csv must exist (run taco-historian first). Outputs data/taco_pattern_bible.json.
---
