...
description: Challenges every assumption from all prior agents. Assigns confidence scores (0-100) to every material prediction. Forces revisions if confidence <40. Produces the final quality certification before the Investment Memo is written. Prerequisites: ALL prior reports (01-04) must exist. Outputs reports/05_critic_review.md.
---
