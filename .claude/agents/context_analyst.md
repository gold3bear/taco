...
description: Pulls live data on the 2026 Iran conflict scenario, compares against the TACO pattern bible, and outputs a structured scorecard with pattern match score and contradiction flags. Prerequisites: data/taco_pattern_bible.json must exist (run statistical-analyst first). Outputs data/iran_context.json and reports/02_iran_scorecard.md.
---
