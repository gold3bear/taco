...
| Parameter | Value |
|---|---|
| Entry | $583 (current) or limit $571 (-2% on any intraday dip) |
| Target | $620 (+6.4%, 14-day horizon) |
...
| Expected Value (30d) | -4.49% |
| Risk/Reward | 0.7:1 (upside vs bear-case downside) |
| Scenario-Weighted Sharpe | -2.61 |
...
| Parameter | Value |
|---|---|
| Entry | Short at $59 (current) — put options preferred for defined risk |
| Target | $56 (-5.0%, 7-14 day cover) |
...
**Scenario Performance (7d):**
- Base Taco: +5.0% profit (short gains)
- Bullish Taco: +8.0% profit
- Bearish War: -12.0% loss (short squeeze risk)
...
| Parameter | Value |
|---|---|
| Entry | $436 (current) — scale in 1-2% now, add if war signals emerge |
| Target | TACO case: $429 (minor loss, exit). War case: $458 (+5.0%) |
...
**Scenario Performance (7d):**
- Base Taco: -1.5% (minor loss accepted as insurance cost)
- Bullish Taco: -2.5%
- Bearish War: +5.0% (safe haven inflow)

---

## T4: LONG BTC-USD — Bitcoin (risk-on alpha)

**Rationale:** BTC historically leads risk-on recovery after geopolitical TACO events. Higher beta than QQQ. Only appropriate if conviction on TACO is high. High volatility — small position only.

| Parameter | Value |
|---|---|
| Entry | $68,305 (current). Only enter if VIX begins falling from peak. |
| Target | $72,403 (+6.0%, 7-14 days) |
...
- ✓ Single trade cap ≤5%
- ✓ Total position cap ≤10%
- ✓ Cash reserve ≥20% (88% maintained)
- ✓ All stop-losses are fundamental triggers (not price levels)
